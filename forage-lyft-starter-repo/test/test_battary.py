...
from battary.nibbin_battery import NubbinBattery
from battary.spindier_battery import SpindlerBattery
...
class TestSpindlerBattery(unittest.TestCase):
    def setUp(self):
        ...
        more_than_three_years_ago = today - timedelta(days=365*2+1)  # 1096 days ago
        less_than_three_years_ago = today - timedelta(days=365*2-1)  # 1094 days ago
